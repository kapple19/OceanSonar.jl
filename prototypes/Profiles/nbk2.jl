...
# ╔═╡ c5bef425-4966-48de-8173-bbc43834a170
using DataInterpolations

# ╔═╡ 300b5c15-d922-4faa-bfd7-f49bb86b0717
using NaturalNeighbours

# ╔═╡ 32aededb-9caf-45fb-a13b-cca5eba2d076
using ForwardDiff

# ╔═╡ b67d1140-e1f2-4eca-a406-a86724466772
using CairoMakie

# ╔═╡ f2781840-6e5f-11ef-0075-73e9ca372b03
md"""
# Ocean Sonar Profiles
"""

# ╔═╡ 941d6ae5-7ed6-4509-a1db-a5026f225747
begin
...
# ╔═╡ 0451a42e-816f-4494-8b6d-50a5cdda3fbf
function prep_for_extrapolation_(::Val{:Flat}, F, X)
	
end

# ╔═╡ 0366b8c1-dffb-41aa-9978-8209e54c8641
function interpolation_(::Val{:Linear}, xtp_model::Val{XTP}, F, x) where {XTP}
	(F_itp, x_itp) = prep_for_extrapolation_(xtp_model, F, x)
	LinearInterpolation(F_itp, x_itp)
end

# ╔═╡ 3901b7ac-1675-4323-b618-cadff528417c
struct Interp1D_Range <: Interp1D
	fcn::Function
	F::Vector{<:Float64}
	r::Vector{<:Float64}

	function Interp1D_Range(
		F::AbstractVector{<:Real},
		r::AbstractVector{<:Real};
		itp_model::Val = Val{:Linear},
		xtp_model::Symbol = Val{:Flat}
	)
		@assert r |> issorted
		@assert r[begin] == 0
		...
		itp = linear_interpolation_(Val(itp_model), Val(xtp_model), )
...
[compat]
CairoMakie = "~0.12.9"
DataInterpolations = "~6.4.0"
ForwardDiff = "~0.10.36"
NaturalNeighbours = "~1.3.5"
"""
...
manifest_format = "2.0"
project_hash = "4daaf223897fa993549f59fd98245c265d65a7e1"
...
git-tree-sha1 = "10b07a0c9edca784875c782206f66a4b68ac403f"
