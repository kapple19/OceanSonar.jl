...
# ╔═╡ 62be4121-d736-4255-b154-ee4d1952dae5
using CairoMakie

# ╔═╡ 80f12ae0-6de2-11ef-2f84-05ccf18b68e1
md"""
# Equidistributed Spherical Points
Markus Deserno, _How to generate equidistributed points on the surface of a sphere_, Sept 28 2004
"""

# ╔═╡ cd9fd711-60d9-458d-87dd-fc31ea239d19
function equidistributed_spherical_angles_(r, N)
	Ncount = 0
	a = 4π * r^2 / N
	d = sqrt(a)
	Mθ = round(π/d)
...
# ╔═╡ deac0f00-13e8-4e55-a724-1c9329f18359
# (θs, ϕs) = equidistributed_spherical_angles_(1, 100)

# ╔═╡ 6cfc9209-bccf-4c60-894b-589d5e5617bf
...
# ╔═╡ 4ef616de-98f3-481c-9dae-a272afb44770
function equidistributed_spherical_angles(N)
	a = 4π / N
	d = sqrt(a)
	Mϕ = round(π/d)
...
# ╔═╡ e0b84b16-5f25-4584-a17d-8a70eda80bc3
(θs, ϕs) = equidistributed_spherical_angles(1000)

# ╔═╡ d6b53464-b27c-4208-a10e-6c81d4af2b36
(θs, ϕs) .|> length

# ╔═╡ c165b91e-3b17-492e-86af-674d2c56764b
θs

# ╔═╡ 48107e30-61f1-48c1-a3e3-3bf2d812788b
ϕs

# ╔═╡ c467cdf0-23ab-4cc3-a2ff-bd8b35c25ddf
θs .|> rad2deg

# ╔═╡ 6877efa1-e910-41f5-9ea4-7992a44f92e5
ϕs .|> rad2deg

# ╔═╡ 5964f6b6-72b4-4876-8173-6e0828a1904a
scatter(θs .|> rad2deg, ϕs .|> rad2deg)

# ╔═╡ b8df3d1f-a17d-4c04-a9cc-a566d16d6d9c
x = @. cos(ϕs) * sin(θs)
